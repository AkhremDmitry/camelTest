...
public class CallRestClientTest {
    ...
    public void getCallByIdTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"calls/1", Call.class))
                .andReturn(entity);
    ...
    public void addCallTest() {
        ...
        EasyMock.expect(mockRestTemplate
                .postForEntity(URL+"calls", expCall, Call.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void updateCallTest() {
        mockRestTemplate.put(URL+"calls", expCall);
    ...
    public void deleteCallByIdTest() {
        mockRestTemplate.delete(URL+"calls/1");
        EasyMock.expectLastCall();
        EasyMock.replay(mockRestTemplate);
    ...
    public void getAllCallTest() {
        ...
        EasyMock.expect(mockRestTemplate
                .getForEntity(URL+"calls", List.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void getAllCallByDateTest() {
        ...
        EasyMock.expect(mockRestTemplate
                .getForEntity(URL+"calls/2018-03-14/2018-03-15", List.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
