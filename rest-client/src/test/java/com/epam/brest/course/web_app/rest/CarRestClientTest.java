...
public class CarRestClientTest {
    ...
    public void getAllCarsDtoTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"carsDto", List.class))
                .andReturn(entity);
    ...
    public void getCarByIdTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"cars/1", Car.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void addCarTest(){
        ...
        EasyMock.expect(mockRestTemplate
                .postForEntity(URL+"cars", expCar, Car.class))
    ...
    public void updateCarTest(){
        mockRestTemplate.put(URL+"cars", expCar);
    ...
    public void deleteCarByIdTest(){
        mockRestTemplate.delete(URL+"cars/1");
        EasyMock.expectLastCall();
        EasyMock.replay(mockRestTemplate);
    ...
    public void getNumberOfCarsTest() {
        int numOfCar = 3;
        EasyMock.expect(mockRestTemplate
                .getForObject(URL+"carsNum", Integer.class))
                .andReturn(numOfCar);
        EasyMock.replay(mockRestTemplate);
    ...
    public void getAllCarsDtoWithCrewTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"cars", List.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
