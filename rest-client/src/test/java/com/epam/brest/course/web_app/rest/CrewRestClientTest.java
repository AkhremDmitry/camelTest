...
public class CrewRestClientTest {
    ...
    public void getAllCrewDtoTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"crewsDto", List.class))
                .andReturn(entity);
    ...
    public void getCrewByIdTest(){
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"crews/1", Crew.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void addCrewTest(){
        ...
        EasyMock.expect(mockRestTemplate
                .postForEntity(URL+"crews", expCrew, Crew.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void updateCrewTest(){
        mockRestTemplate.put(URL+"crews", expCrew);
    ...
    public void deleteCrewByIdTest(){
        mockRestTemplate.delete(URL+"crews/1");
        EasyMock.expectLastCall();
        EasyMock.replay(mockRestTemplate);
    ...
    public void getAllCrewDtoWithCallTest() {
        ...
        EasyMock.expect(mockRestTemplate.getForEntity(URL+"crews", List.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
    ...
    public void getAllCrewDtoWithCallByDateTest() {
        ...
        EasyMock.expect(mockRestTemplate
                .getForEntity(URL+"crews/2018-03-14/2018-03-15",
                        List.class))
                .andReturn(entity);
        EasyMock.replay(mockRestTemplate);
